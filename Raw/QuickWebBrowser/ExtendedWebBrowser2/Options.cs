...
namespace ExtendedWebBrowser2
{
    internal partial class Options : Form
    {
        ...
        {
            SettingsHelper settingsHelper = SettingsHelper.Current;
        ...
        private void OkButton_Click(object sender, EventArgs e)
        {
            ...
            settingsHelper.TranslationAlgorithm = algorithm_LongestVietPhraseFirstRadioButton.Checked ? 0 : (algorithm_LeftToRightRadioButton.Checked ? 1 : 2);
