...
namespace QuickTranslator
{
    ...
    public class Configuration
    {
        ...
        public Color Style_TrungForeColor = default;

        public Color Style_HanVietForeColor = default;

        public Color Style_VietPhraseForeColor = default;

        public Color Style_VietPhraseOneMeaningForeColor = default;

        public Color Style_VietForeColor = default;

        public Color Style_NghiaForeColor = default;

        public Color Style_TrungBackColor = default;

        public Color Style_HanVietBackColor = default;

        public Color Style_VietPhraseBackColor = default;

        public Color Style_VietPhraseOneMeaningBackColor = default;

        public Color Style_VietBackColor = default;

        public Color Style_NghiaBackColor = default;
